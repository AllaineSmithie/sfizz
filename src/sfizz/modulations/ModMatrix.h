...
namespace sfz {
    ...
    public:
         ...
         * @param numFrames
         */
        void beginCycle(unsigned numFrames, const bool avoidBufferReadyToFalsIterations = false);

        /**
         * @brief End modulation processing for the entire cycle.
         * This performs a dummy run of any unused modulations.
         */
        void endCycle(const bool avoidEndCycleGenerateDiscardedIterations = false);
