...
namespace sfz
{
    ...
    */
    ...
    public:
        ...
        * @11.06.23 RJ
        */
        bool getVoiceBufferCopy(const int p_voice_id, float** p_out, int numChannels, size_t numSamples) noexcept;

        /**
        * @brief sets/returns the current buffer frames position of the voice
        * @11.06.23 RJ
        */
        void setVoicePosition(const int p_voice_id, const int numframes) noexcept;
        int getVoicePosition(const int p_voice_id) const noexcept;
        ...
        */
        ...
        void renderVoiceBlock(const int voice_id, float** buffers, size_t numSamples, int numOutputs) noexcept;

        /** RJ 12.06.23
         * @brief Configures everything renderBlock() would do, but avoids
         * rendering any audio except of the metronome
         * Use this, if audio is fetched by renderVoiceBlock to trigger
         * garbage collection.
         *
         * @param buffer the buffer to write the next block into; this should be a
         * stereo buffer.
         */
        void renderBlockEmpty(float** buffers, size_t numSamples, int numOutputs) noexcept;
